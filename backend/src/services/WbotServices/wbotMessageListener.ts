...
const getTypeMessage = (msg: proto.IWebMessageInfo): string => {
  return String(getContentType(msg.message));
};
...
const getContactMessage = async (msg: proto.IWebMessageInfo, wbot: Session) => {
  ...
  // Para mensagens de grupos, usar o participant
  if (isGroup) {
    return {
  ...
  // Para mensagens individuais, verificar se é @lid (link/canal/comunidade)
  // Se for @lid, tentar extrair o número real do key.participant
