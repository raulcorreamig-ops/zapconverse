...
system_git_clone() {
  ...
  sudo su - deploy <<EOF
  git clone https://zapconverse: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@github.com/zapconverse/zapconverse.git /home/deploy/${instancia_add}/
EOF
